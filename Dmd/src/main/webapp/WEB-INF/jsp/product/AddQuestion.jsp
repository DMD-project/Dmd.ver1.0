...
<body>
	<div id = "left" align = "center">
		<table>
			<th style = 'border: none; font-size: 20px'>질문 등록하기</th>
			<tr>
				<td>
					Title
			...
			<tr>
				<td>
					keyword
					<select name = "keyword" class = "formStyle" style = 'border: solid 1px; border-radius: 5px; width: 100px; color: rgb(139, 139, 139); text-align: center'>
						<option>--키워드--</option>
					</select>
				</td>
			</tr>
