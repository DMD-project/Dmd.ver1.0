...
<body>
	<div id = "left" align = "center">
		<table>
			<th style = 'border: none; font-size: 20px'>공동구매 상품 등록하기</th>
			<tr>
				<td>
					상품명
			...
			<tr>
				<td>
					할인율 &nbsp;&nbsp;&nbsp;&nbsp;
					<input type = "text" name = "title" size = "15" class = "formStyle"> %
				</td>
			</tr>
			<tr>
				<td>
					목표 인원
					<input type = "text" name = "title" size = "15" class = "formStyle"> 명
				</td>
			</tr>
			<tr>
				<td>
					진행 기간
					<input type="date" class = "formStyle" min = "2023-01-01" max = "2029-12-31" style = 'border: solid 1px; border-radius: 5px; width: 100px; color: rgb(139, 139, 139)'>
					<input type="time" class = "formStyle">
					&nbsp; ~ &nbsp;
					<input type="date" class = "formStyle" min = "2023-01-01" max = "2029-12-31" style = 'border: solid 1px; border-radius: 5px; width: 100px; color: rgb(139, 139, 139)'>				
					<input type="time" class = "formStyle">
				</td>
